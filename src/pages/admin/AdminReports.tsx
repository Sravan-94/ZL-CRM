  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch leads
        try {
          const leadsData = await fetchWithRetry('https://crm.infororg.com/api/leads/getall');
        ...
        // Fetch users
        try {
          const usersData = await fetchWithRetry('https://crm.infororg.com/api/bda-users');
          setUsers(usersData);
        } catch (err) {
        ...
        // Fetch lead history
        try {
          const historyData = await fetchWithRetry('https://crm.infororg.com/api/leads/history');
